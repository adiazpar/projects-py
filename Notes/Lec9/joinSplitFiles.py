...
# /Users/yzhuang/PycharmProjects/CS3080-FA23/Lec9
...
#   File "/Users/yyzh/PycharmProjects/CS3080/Lec9/joinSplitFiles.py", line 31, in <module>
#     os.chdir(os.path.join('/Users','nonExistingUser', 'Downloads'))
# FileNotFoundError: [Errno 2] No such file or directory: '/Users/nonExistingUser/Downloads'

os.chdir('/Users/yzhuang/PycharmProjects/CS3080-FA23/Lec9')
os.makedirs(os.path.join('.', 'lectures', 'lecture9', 'testfolder', 'subfolder'))
# 'lectures/lecture9/testfolder/subfolder' will be created under /Users/yzhuang/Downloads
